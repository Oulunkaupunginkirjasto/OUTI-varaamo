...
describe('Container: SearchControls', () => {
  ...
  beforeEach(() => {
    props = {
      ...
      calendarAvailability: { '2015-10-10': true },
      isFetchingPurposes: false,
      isFetchingUnits: false,
      fetchDates: getStartAndEndMoments('2015-10-10'),
      filters: {
        date: '2015-10-10',
  ...
  describe('rendering SearchInput', () => {
    ...
    it('should not render SearchInput component', () => {
      expect(searchInputTrees.length).to.equal(0);
    });
  });

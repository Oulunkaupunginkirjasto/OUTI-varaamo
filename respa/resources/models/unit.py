...
class Unit(ModifiableModel, AutoIdentifiedModel):
    ...
    def get_reservable_before(self):
        return create_reservable_before_datetime(self.reservable_days_in_advance, tz=self.get_tz())

    def get_reservable_after(self):
        return create_reservable_after_datetime(self.reservable_after_days, tz=self.get_tz())

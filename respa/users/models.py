...
class KohaUserIdentifier(models.Model):
    borrowernumber = models.BigIntegerField(primary_key=True)
    user = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='koha_identifier')

    class Meta:
        verbose_name = _('koha identifier')
        verbose_name_plural = _('koha identifiers')
